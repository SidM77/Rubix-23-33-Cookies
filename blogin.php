<?php 
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $password = $_POST["password"];
            ...
            $sql = "Select * from buyer where bemailid ='$bemailid' AND password='$password'";
            ...
            if ($num == 1){
                ...
                $_SESSION['bemailid'] = $bemailid;
                header("location: buyit.php");
            }
...
<div class="panel">
    ...
    <p class="logo"> <span class="style"><img src="copy-removebg-preview.png" alt="alternatetext" class="image"></span><span class="site-name">Fresh Fields</span></p>
    <a href="bsignup.php"><button class="contactus">SIGNUP</button></a>
            ...
            <div class="enter1">    
                <div class="container">
                    ...
                    <div class="frame">
                                    ...
                                    <form action="/rubix23/bLogin.php" method="post">
                                    <div class="form-group">
                                        <p class="user">
                                        <label class = "field-desc" for="bemailid">Email ID</label>
                                        <input type="text" class="form-control" id="bemailid" name="bemailid" aria-describedby="emailHelp">
                                        </p>
                                    </div>
