<?php 
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        //$exists=false;
        $existSql = "SELECT * FROM `buyer` WHERE bemailid = '$bemailid'";
        ...
        if($numExistRows > 0){
            ...
            if(($password == $cpassword)){
                ...
                $sql = "INSERT INTO `buyer` (`name`, `contactno`, `bemailid`, `password`, `dt`) VALUES ('$name', '$contactno', '$bemailid', '$password', current_timestamp())";
...
<div class="panel">
            ...
            <a href="/rubix23/flogin.php"><button class="contactus">LOGIN</button></a>
        ...
        <div class="body" id="bg-1">
            <div class="enter1">    
                <div class="container">
                    ...
                    <div class="frame">
                    <form action="/rubix23/bsignup.php" method="post">
