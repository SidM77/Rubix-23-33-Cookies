    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if($numExistRows > 0){
            ...
            if(($password == $cpassword)){
                ...
                $sql = "INSERT INTO `farmer` (`fname`, `contactno`, `emailid`, `password`, `dt`) VALUES ('$fname', '$contactno', '$emailid', '$password', current_timestamp())";
        ...
        <div class="body" id="bg-1">
            <div class="enter1">    
                <div class="container">
                    ...
                    <p class="user">
                        <label class = "field-desc" for="fname">Name</label>
